...
const services = [
  {
    ...
    what: 'HomeSecure™ is PNLT\'s core offering. It gives foreign nationals the right to live in a single-family home in the Philippines — long-term, securely, and without relying on informal arrangements, partner names, or corporate workarounds. PNLT is a non-profit corporation registered with the Philippine SEC, 100% Filipino-owned, and fully aligned with the Philippine Constitution. HomeSecure™ does not give foreigners the right to buy or sell property. What it provides is the right to live — secure, protected residential rights backed by PNLT\'s Articles of Incorporation and By-Laws.',
    how: [
      ...
      'A legally structured residential rights agreement is executed and registered',
      'You move in. PNLT administers the trust on an ongoing basis with a licensed attorney overseeing all legal aspects',
      'Beneficiary nomination — you designate a qualified Filipino nominee who will receive full ownership upon cancellation or expiry of the agreement',
    ],
    who: 'Retirees who want a permanent home instead of an endless cycle of rentals. Expat families needing long-term stability. SRRV holders. Long-stay visa holders. Anyone committed to living in the Philippines who wants a legally sound foundation.',
    benefits: [
      'Full constitutional compliance — no workarounds, no dummy setups',
      'You are not dependent on any personal relationship or partner\'s name on a title',
      ...
      'Beneficiary nomination gives you peace of mind about what happens to the home',
      'If the relationship with your partner changes, your housing remains secure',
      'Courts have consistently ruled against informal setups — HomeSecure™ is built to withstand legal scrutiny',
    ],
    extra: {
      title: 'What Happens to the Home When the Agreement Ends?',
      text: 'Upon cancellation or expiration of your HomeSecure™ agreement, PNLT is institutionally obligated to transfer full ownership to your nominated beneficiary — provided that person is a Filipino citizen legally qualified to own real estate in the Philippines. This is not discretionary. It is written into PNLT\'s Articles of Incorporation. It means the home you secured can go to someone you trust — a spouse, a child, a partner — while remaining fully compliant with Philippine law.',
    },
  },
  {
    id: 'transitionsecure',
